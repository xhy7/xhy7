...
<script>
  // 初始化 LeanCloud
  AV.init({
    appId: 'xX3VwKU8zGdlW2X9iVfKNQh2-gzGzoHsz',
    appKey: 'MJ8GqCzNhjprX3lHwsPehH61',
    serverURL: 'https://xx3vwku8.lc-cn-n1-shared.com' // 格式：https://<app-id>.api.lncldglobal.com
  });
